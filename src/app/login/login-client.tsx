...
import { Activity, BookOpenText, Globe2, ShieldCheck, Sparkles } from "lucide-react";
...
function PipMascot(){
  return <motion.div
    ...
    transition={{delay:.08,type:"spring",bounce:.32,duration:.75}}
    className="relative mx-auto mb-7 w-[150px] sm:w-[168px]"
    aria-label="Pip, Quill's companion"
  >
    <motion.div
